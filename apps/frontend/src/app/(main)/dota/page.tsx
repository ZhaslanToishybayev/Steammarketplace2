...
export default function DotaPage() {
  ...
  const formatMeta = (item: any) => {
    ...
    const hero = get('hero');
    return [hero, rarity, type].filter(Boolean).join(' • ');
  };
      ...
      <div className="min-h-screen bg-black">
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="text-center">
            ...
            <div className="text-muted-foreground">Loading Dota 2 inventory...</div>
          </div>
        </div>
      </div>
    );
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6">
            <div>
              ...
              <h1 className="text-4xl font-bold mb-2">Dota 2 Inventory</h1>
              <p className="text-muted-foreground">Your Dota 2 cosmetics, sets, immortals and items</p>
            </div>

            {user && (
              <div className="mt-4 md:mt-0">
                <div className="text-right">
                  <div className="text-muted-foreground text-sm">Steam ID</div>
                  <div className="font-mono">{user.steamId}</div>
                </div>
              </div>
            )}
          </div>
        ...
        {!user ? (
          <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-12 text-center">
            <div className="h-20 w-20 bg-red-500/20 rounded-2xl flex items-center justify-center mx-auto mb-8">
              <span className="text-3xl">⚔️</span>
            </div>
            <h2 className="text-2xl font-bold text-white mb-4">Login to View Dota 2 Inventory</h2>
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              Connect your Steam account to view your Dota 2 cosmetics, sets, and items
            </p>
            <button
              onClick={handleLogin}
          ...
          <div className="bg-gradient-to-br from-red-900/20 to-black border border-red-800/30 rounded-2xl p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">Error Loading Dota 2 Inventory</h2>
            <p className="text-gray-300 mb-6">{error}</p>
            <div className="text-gray-500 text-sm space-y-2 max-w-md mx-auto">
              <p>Common issues:</p>
              <p>• Steam inventory set to private</p>
              <p>• No Dota 2 items in inventory</p>
          ...
          <div className="bg-gradient-to-br from-gray-900/20 to-black border border-gray-800 rounded-2xl p-12 text-center">
            ...
            <h2 className="text-2xl font-bold text-white mb-4">No Dota 2 Items Found</h2>
            <p className="text-gray-400 mb-6">
              Your Dota 2 inventory appears to be empty or private
            </p>
            <div className="text-gray-500 text-sm space-y-1 max-w-md mx-auto">
              <p>To see your Dota 2 items:</p>
              <p>1. Make sure you have Dota 2 items in your Steam inventory</p>
          ...
          <>
            {/* Stats */}
            <div className="bg-gradient-to-br from-red-900/20 to-black border border-red-800/30 rounded-2xl p-6 mb-8">
              <div className="flex flex-col sm:flex-row items-center justify-between">
                <div className="mb-4 sm:mb-0">
                  <h2 className="text-xl font-bold text-white mb-2">Dota 2 Inventory Overview</h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-4">
              {(inventory?.items || []).map((item) => (
                <div
                  ...
                  className="group bg-gradient-to-b from-gray-900 to-black border border-gray-800 hover:border-red-500 rounded-xl p-3 transition-all hover:scale-[1.02]"
                >
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-400 text-sm">
                Showing {(inventory?.items || []).length} Dota 2 items •
