                                ...
                                >
                                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                                        <h2 className="text-2xl font-bold text-white">
                                            {sellMode === 'listing' ? 'P2P Listing' : 'Instant Payout'}
                                        </h2>
                                        <div className="flex rounded-xl bg-white/5 border border-white/10 p-1">
                                            <button
                                                type="button"
                                                onClick={() => setSellMode('instant')}
                                                className={`px-4 py-2 rounded-lg text-sm font-semibold transition ${sellMode === 'instant' ? 'bg-amber-500 text-white' : 'text-gray-400 hover:text-white'}`}
                                            >
                                                Instant
                                            </button>
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-lg text-sm font-semibold transition ${sellMode === 'listing' ? 'bg-cyan-500 text-white' : 'text-gray-400 hover:text-white'}`}
                                            >
                                                P2P
                                            </button>
                                        </div>
                                            ...
                                            >
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <Input
                                                        ...
                                                        placeholder="25.00"
                                                        className="h-12 bg-white/5 border-white/10 text-white placeholder:text-gray-500 rounded-xl focus:border-cyan-500"
                                                        required
                                                    />
                                                    <p className="text-sm text-gray-400">
                                                        Buyer funds are reserved first. Seller payout is released after Steam trade acceptance and the hold period.
                                                    </p>
                                                </div>
                                                )}
                                                ...
                                                >
                                                    ...
                                                    <div className="flex items-center gap-6">
                                                        <div className="text-right">
                                                            ...
                                                            <Badge className={
                                                                listing.status === 'OPEN' || listing.status === 'active'
