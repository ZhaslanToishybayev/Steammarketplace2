...
export const ItemCard = React.memo(function ItemCard({
    ...
    return (
        <>
            <Card
                className={`item-card cursor-pointer group hover:shadow-lg transition-all duration-300 border-0 bg-[var(--bg-secondary)] overflow-hidden ${selected ? 'ring-2 ring-[var(--accent-blue)]' : ''}`}
