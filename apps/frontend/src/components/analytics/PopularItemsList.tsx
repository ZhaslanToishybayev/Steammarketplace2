                             ...
                             {item.image_url ? (
                                <img
                                    src={item.image_url.startsWith('http')
                                        ? `/image-proxy?url=${encodeURIComponent(item.image_url)}`
                                        : `/image-proxy?url=${encodeURIComponent(`https://community.cloudflare.steamstatic.com/economy/image/${item.image_url}`)}`
                                    }
