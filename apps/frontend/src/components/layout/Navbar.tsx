                        ...
                        <div className="flex items-center gap-2 md:gap-3">
                            {user ? (
                                <>
                                    ...
                                    <div className="flex items-center gap-1 bg-[#4CAF50]/10 text-[#4CAF50] px-3 py-1.5 rounded-lg font-mono font-bold border border-[#4CAF50]/20 text-sm cursor-default">
