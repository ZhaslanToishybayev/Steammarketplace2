...
// Прямое создание trade offer через Steam бота

const SteamUser = require('steam-user');
const SteamCommunity = require('steamcommunity');
const TradeOfferManager = require('steam-tradeoffer-manager');

console.log('🎮 СОЗДАНИЕ TRADE OFFER НАПРЯМУЮ ЧЕРЕЗ STEAM БОТА');
console.log('=====================================================');
console.log('');
...
const steamApiKey = 'E1FC69B3707FF57C6267322B0271A86B';
