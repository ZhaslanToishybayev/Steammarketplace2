...
// Mock SteamBot
jest.mock('../../apps/backend/src/services/steam-bot.service', () => {
...
jest.mock('../../apps/backend/src/services/scam-protection.service', () => ({
...
describe('BotManager', () => {
  ...
  describe('Trade Offers', () => {
    ...
    test('should check scam protection before sending offer', async () => {
      const scamProtection = require('../../apps/backend/src/services/scam-protection.service');
